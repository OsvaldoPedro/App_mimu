        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <Link to="/" className="flex items-center group">
              <img src="/mimu-logo.png" alt="Mimu Logo" className="h-[44px] md:h-[54px] w-auto object-contain transition-transform group-hover:scale-105" />
            </Link>
          </div>
          ...
          <div className="lg:hidden flex items-center gap-1.5 sm:gap-3">
            ...
            <button
              onClick={toggleTheme}
              className="w-10 h-10 flex items-center justify-center rounded-full text-mimu-white-text hover:text-mimu-gold hover:bg-white/10 dark:hover:bg-white/5 transition-all duration-300"
              title={theme === 'dark' ? 'Light Mode' : 'Dark Mode'}
            >
              {theme === 'dark' ? (
                <svg className="w-6 h-6 text-mimu-gold fill-current" viewBox="0 0 24 24">
