...
export default function RegisterCompanyPage() {
  const [form, setForm] = useState({
    companyName: '', email: '', phone: '', address: '', province: '', description: '',
    categoryId: '', serviceTypes: [], basePrice: '', hours: '', logo: '', password: ''
  })
    ...
    <div className="min-h-screen bg-[#F4E8D8]">
      ...
      <main className="pt-24 pb-16 px-4">
        <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow-xl p-8">
          ...
          <h1 className="text-2xl font-bold text-[#3A0D0D] mb-2">Conta Empresarial</h1>
          <p className="text-[#5C1A1A]/80 mb-2">A conta ficará "Pendente de Aprovação" até validação do Administrador.</p>
          <p className="text-amber-700 text-sm mb-6">Após registo, terás acesso ao painel da empresa.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-[#3A0D0D] mb-2">Email profissional</label>
            ...
            <div>
              <label className="block text-sm font-medium text-[#3A0D0D] mb-2">Endereço</label>
            ...
            <div>
              <label className="block text-sm font-medium text-[#3A0D0D] mb-2">Descrição da empresa</label>
            ...
            <div>
              <label className="block text-sm font-medium text-[#3A0D0D] mb-2">Categoria de serviços</label>
            ...
            <div>
              <label className="block text-sm font-medium text-[#3A0D0D] mb-2">Logotipo (URL opcional)</label>
