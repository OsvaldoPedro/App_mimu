...
export default function MyServicesPage() {
  ...
  const loadServices = () => {
    if (user?.id) getCompanyServices(user.id).then(setServices)
  }
  ...
  if (!user || !isCompany) {
    return (
      <div className="min-h-screen bg-mimu-cream dark:bg-[#121212] flex items-center justify-center">
        <p className="text-mimu-wine-light-text dark:text-gray-300">Apenas empresas podem aceder a esta página.</p>
        ...
        <div className="max-w-6xl mx-auto w-full">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
            <div>
              ...
              <p className="text-mimu-wine-light-text dark:text-gray-300/80">Gerir os serviços da sua empresa.</p>
            </div>
            <Link
          ...
          <div className="mt-6">
            <Link to="/empresa" className="text-mimu-gold font-medium hover:underline">
