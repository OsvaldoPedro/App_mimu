  ...
  if (!user || !isProvider) {
    return (
      <div className="min-h-screen bg-[#F4E8D8] flex items-center justify-center">
        <p className="text-[#5C1A1A]">Apenas prestadores podem aceder a esta página.</p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
            <div>
              ...
              <p className="text-[#5C1A1A]/80">Gerir os seus serviços como prestador.</p>
            </div>
            <Link
                ...
                >
                  <Link to={`/servico/${service.id}`} className="block">
                    <div className="relative h-40 overflow-hidden">
                      ...
                      <span className="absolute top-2 right-2 px-2 py-1 rounded-lg bg-amber-100 text-amber-800 text-xs font-medium">
          ...
          <div className="mt-6">
            <Link to="/prestador" className="text-[#C58A2B] font-medium hover:underline">
